export const RECOMMENDED_PREACT_VERSION = "10.11.2";
export const RECOMMENDED_PREACT_RTS_VERSION = "5.2.6";
export const RECOMMENDED_PREACT_SIGNALS_VERSION = "1.1.2";
export const RECOMMENDED_PREACT_SIGNALS_CORE_VERSION = "1.2.2";
