...
//
//Deno.test("Path-specific middleware", async (t) => {
//  const app = new App();
//  const log: string[] = [];
//
//  // Global middleware
...
//  await t.step("should apply middleware only to matching paths", async () => {
...
//  //  });
//  //
//  //  it("should extract params from middleware patterns", async () => {
//  //    const app = new App();
//  //    let params = {};
//  //
...
//  //  });
//  //
//  //  it("should handle middleware and routes in the correct order", async () => {
//  //    const app = new App();
//  //    const order: string[] = [];
//  //
