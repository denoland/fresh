...
describe("islands/SearchButton.tsx", () => {
  ...
  it("should contain class applied in props", () => {
    ...
    // @ts-ignore mock impl
    const dsearch = fn(docsearch).mockImplementation((applId, apiKey, indexName, container) => "foobar");
    const { getByTitle } = render(<SearchButton class="font-bold" docsearch={dsearch}/>);
