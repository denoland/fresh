...
export function deno(): Plugin {
  ...
  return {
    ...
    async configResolved() {
      ...
      // FIXME: Remove entrypoints once https://github.com/denoland/deno-js-loader/issues/29 is fixed
      loader = await new Workspace({})
        .createLoader({ entrypoints: ["fresh", "fresh/do-not-use"] });
    },
    applyToEnvironment() {
      return true;
    },
