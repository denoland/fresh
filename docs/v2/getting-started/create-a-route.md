...
concept is called _File-system routing_.

> [info]: Fresh also supports defining routes using a traditional declarative
> router API. This is useful for when you need to customize the behavior of a
> route beyond what is possible with file-system routing.
>
> You can learn more about all things related to routing on the
